...
/*   Updated: 2019/02/05 19:56:22 by rpinoit          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vector vector_multiply_ret(const t_vector *a, const t_vector *b)
{
    t_vector ret;
...
t_vector vector_multiply_const_ret(const t_vector *vector, const double amount)
{
    t_vector ret;
